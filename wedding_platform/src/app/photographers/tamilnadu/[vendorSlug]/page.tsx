    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/photographers/tamilnadu" className="bg-pink-600 text-white px-6 py-3 rounded-lg hover:bg-pink-700">
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/photographers/tamilnadu" className="text-gray-700 hover:text-pink-600 font-medium">Photographers</Link>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex text-sm text-gray-600">
            ...
            <Link href="/photographers/tamilnadu" className="hover:text-pink-600">Photographers</Link>
            <span className="mx-2">/</span>
            <Link href="/photographers/tamilnadu" className="hover:text-pink-600">Tamilnadu</Link>
            <span className="mx-2">/</span>
      ...
      <section className="py-12 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Get in touch today to discuss your wedding photography needs</p>
